...
/// <summary>
/// Tempo and pitch shaping for synthesised speech, ported unchanged from v2.
///
/// The settings below are tuned for voice rather than music: shorter sequence and overlap
/// windows keep consonants intact when the tempo is pushed, which is what stops a
/// sped-up voice sounding like it is gargling.
/// </summary>
